...
func printTaskHelp() {
	...
	fmt.Println("  <title>               Positional title (or use -title)")
	fmt.Println("  -title <text>         Task title")
	fmt.Println("  -project_id <id>      Project ID (defaults to current/default project)")
	...
	fmt.Println("  -task_id <id>         Task ID to update")
	fmt.Println("  -title <text>         Task title")
	fmt.Println("  -description <text>   Task description")
	fmt.Println("  -status <status>      Task status")
	fmt.Println("  -priority <level>     Priority (low|medium|high|critical)")
	fmt.Println("  -acceptance <text>    Acceptance criteria")
	fmt.Println("  -acceptance_criteria <text>  Acceptance criteria (alias)")
	fmt.Println()
	...
	fmt.Println("      -project_id proj_abc123 \\")
	fmt.Println("      -type task \\")
	fmt.Println("      -description \"Build REST API endpoints\" \\")
	fmt.Println("      -priority high \\")
	fmt.Println("      -acceptance_criteria \"API accepts and returns JSON\"")
	fmt.Println()
...
func printCLIUsage() {
	...
	fmt.Println("  sf task create (<title> | -title <t>) (-project_id <p> -type <t> -description <d> -priority <p> -acceptance|-acceptance_criteria <a>)")
	fmt.Println("  sf task update -task_id <id> (-title <t> -description <d> -status <s> -priority <p> -acceptance|-acceptance_criteria <a>)")
