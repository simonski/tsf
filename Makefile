.PHONY: help build clean test test-go test-go-unit test-go-coverage test-cli test-cli-harness test-e2e test-e2e-setup docker docker-up docker-down run-local
...
help:
	...
	@echo "  test-cli          - Run markdown-driven CLI integration harness"
	@echo "  test-cli-harness  - Alias of test-cli"
